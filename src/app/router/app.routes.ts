...
export const routes: Routes = [
  ...
  { path: 'favorite', loadComponent: ()=> import('../features/favorite/pages/favorite.page'), canActivate: [authGuard]},
  ...
  { path: 'profile', loadComponent:()=> import('../features/user/components/user-profile/user-profile')},
